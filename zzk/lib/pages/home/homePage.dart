...
import 'package:zzk/main.dart';
import 'package:zzk/pages/orderPage/order.dart';

import '../allergySelector/allergySelector.dart';
import '../uploaderZone/uploaderZonePage.dart';
        ...
        child: ListView(
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text(
                'Welcome to the ${widget.title} restaurant! Please select any dietary restrictions or allergies you may have.',
                style: TextStyle(
                  fontSize: 18,
  ...
  Widget presetChip({required String label, required List<int> turnOnIndex}) => Container(
        ...
        child: InkWell(
          ...
          child: Clicky(
            style: ClickyStyle(
              color: Colors.transparent,
              shrinkScale: ShrinkScale.byRatio(0.1),
            ),
            child: Chip(
